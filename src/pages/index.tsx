      ...
      <div className='items-center flex flex-wrap'>
        <div className='w-full lg:w-6/12 px-4 ml-auto mr-auto text-center'>
          <div className='pr-12'>
            ...
            <p className='mt-4 text-lg text-white font-extralight'>Inteligência de Pesquisas Comunicação & Marketing</p>
          </div>
        </div>
      </div>
    </div>
...
const WhatWeDo = () => {
  ...
  return (
    <section ref={ref} id='o_que_fazemos' className='pb-20 bg-gray-300 -mt-24'>
